...
SOURCE_PATTERN = os.path.expanduser("~/.databento/GLBX.MDP3/RTY_c_0/ohlcv-1m/*/*.parquet")
OUTPUT_FOLDER = "data/raw_rty_extended"
...
for day, group in resampled.groupby("date"):
    filename = f"{OUTPUT_FOLDER}/rty_15m_{day}.csv"
