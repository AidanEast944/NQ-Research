...
SOURCE_PATTERN = os.path.expanduser("~/.databento/GLBX.MDP3/ES_c_0/ohlcv-1m/*/*.parquet")
OUTPUT_FOLDER = "data/raw_es_extended"
...
for day, group in resampled.groupby("date"):
    filename = f"{OUTPUT_FOLDER}/es_15m_{day}.csv"
