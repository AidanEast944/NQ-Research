...
for stop, target in combos_to_test:
    ...
    log_result("prior_day_break", f"stop={stop},target={target}", len(signals), win_rate, avg_points, total_points)